...
sys.path.insert(0, os.path.abspath('../framework/src'))
sys.path.insert(0, os.path.abspath('../framework/util/RUS'))
...
htmlhelp_basename = 'IntegratedPlasmaSimulatorIPSdoc'
...
man_pages = [
    ('index', 'integratedplasmasimulatorips', u'Integrated Plasma Simulator (IPS) Documentation',
     [u'SWIM Project'], 1)
]
