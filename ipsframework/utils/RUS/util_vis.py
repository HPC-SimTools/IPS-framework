...
if __name__ == '__main__':
    ...
    for comp in comp_names_sorted:
        ...
        for i in range(1, max_num_comp_sims + 1):
            ...
            y_plot = y_inc + y_sum
            if i == 1:
                ax1.plot(x, y_plot, label=comp, markeredgecolor='c', markerfacecolor=comp_color[comp], color='k', linewidth=0.5)
            else:
                ax1.plot(x, y_plot, markeredgecolor='c', markerfacecolor=comp_color[comp], color='k', linewidth=0.5)
