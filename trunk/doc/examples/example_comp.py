...
import os, sys         # the usuals
import subprocess  # not used in skeleton, but useful for launching helper scripts
from component import Component  # REQUIRED - all components inherit the IPS Component
...
# ------------------------------------------------------------------------------
    ...
    def step(self, timeStamp):
        ...
        try:
            partial_file = cwd + '/EXAMPLE_' + cur_state_file      # CHANGE TO LOCATION OF PARTIAL PS
