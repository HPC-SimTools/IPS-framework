...
def test_portal(tmpdir):
    ...
    lines = [(int(code), json.loads(data)) for (code, data) in
             [line[74:].strip().split(maxsplit=1) for line in lines if "FWK_COMP_PortalBridge_4 DEBUG    Portal Response: " in line]]
