...
def test_checkpoint_components_num_checkpoint(tmpdir):
    ...
    servicesProxy._send_monitor_event.assert_called_with('IPS_CHECKPOINT_START', 'Components = []')
    ...
    assert ret_dict == {}  # should be empty since no components
    servicesProxy._send_monitor_event.assert_called_with('IPS_CHECKPOINT_END', 'Components = []')
...
def test_checkpoint_components_modes():
    ...
    servicesProxy.sim_conf = {'CHECKPOINT': {'MODE': 'WALLTIME_REGULAR', 'WALLTIME_INTERVAL': '10', 'NUM_CHECKPOINT': '-1'}, 'SIM_ROOT': '/some_dir'}
    servicesProxy.checkpoint_components([], 0)
    servicesProxy._dispatch_checkpoint.assert_not_called()
    ...
    servicesProxy.last_ckpt_walltime = 1000.0
    servicesProxy.cur_time = 1002.0
    servicesProxy.sim_conf = {'CHECKPOINT': {'MODE': 'WALLTIME_EXPLICIT', 'WALLTIME_VALUES': '10 100', 'NUM_CHECKPOINT': '-1'}, 'SIM_ROOT': '/some_dir'}
    servicesProxy.checkpoint_components([], 0)
    servicesProxy._dispatch_checkpoint.assert_not_called()
    ...
    servicesProxy.sim_conf = {'CHECKPOINT': {'MODE': 'PHYSTIME_REGULAR', 'PHYSTIME_INTERVAL': '15', 'NUM_CHECKPOINT': '-1'}, 'SIM_ROOT': '/some_dir'}
    ...
    # PHYSTIME_EXPLICIT
    servicesProxy._dispatch_checkpoint.reset_mock()
    servicesProxy.sim_conf = {'CHECKPOINT': {'MODE': 'PHYSTIME_EXPLICIT', 'PHYSTIME_VALUES': '10 100', 'NUM_CHECKPOINT': '-1'}, 'SIM_ROOT': '/some_dir'}
